# build-knowledge-base-with-react
How to Build a Knowledge Base Powered by React and ButterCMS

## Important Note
This project was created as an example use case of ButterCMS in conjunction with a blog article, [How to Build a Knowledge Base Powered by React and ButterCMS](https://buttercms.com/blog/build-a-knowledge-base-with-react/), and will not be actively maintained.
